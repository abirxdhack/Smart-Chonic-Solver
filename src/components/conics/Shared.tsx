  ...
  return (
    <header className="topbar">
      <Link className="brand" to="/" aria-label="Conic Studio">
        ...
        <span className="brand-text">Conic Studio</span>
      </Link>
      <nav aria-label={t("প্রধান নেভিগেশন")} className={open ? "open" : ""}>
        {NAV.map((n) => (
          <Link
            key={n.to}
            to={n.to}
        ...
        <div className="dev">
          ...
          <div className="dev-info">
            ...
            <ul className="dev-meta">
              <li>
                <Mail size={13} />
                <a href="mailto:abirxdhackz.info.me@gmail.com">abirxdhackz.info.me@gmail.com</a>
              </li>
              <li>
                <Phone size={13} />
  ...
  return (
    <div className="mkb">
      <div className="mkb-head">
        <span>{trs("গণিত কীবোর্ড")}</span>
        <div className="mkb-actions">
          <button onClick={onClear}>{trs("মুছুন")}</button>
          <button onClick={onBackspace}>⌫</button>
          <button onClick={onClose}>{trs("বন্ধ")}</button>
        </div>
      </div>
