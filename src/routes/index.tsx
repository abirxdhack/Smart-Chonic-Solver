    ...
    <PageShell>
      <main>
        <section className="hero">
          <h1>বাংলায় কনিক সেকশনের সম্পূর্ণ ইন্টারেক্টিভ সমাধান</h1>
          <p>
            পরাবৃত্ত, উপবৃত্ত ও অধিবৃত্ত — যেকোন সমীকরণ বা প্যারামিটার থেকে সব
            ধর্ম, ফোকাস, নিয়ামক, উপকেন্দ্রিক লম্ব ও গ্রাফ; প্রতিটি ফলাফলের
            ধাপে ধাপে গাণিতিক ব্যাখ্যা।
          </p>
          <div className="hero-actions">
            <Link to="/parabola" className="icon-btn primary">
              পরাবৃত্ত সমাধান <ArrowRight size={15} />
            </Link>
            <Link to="/ellipse" className="icon-btn">
              উপবৃত্ত <ArrowRight size={14} />
            </Link>
            <Link to="/hyperbola" className="icon-btn">
              অধিবৃত্ত <ArrowRight size={14} />
            </Link>
          </div>
        </section>
