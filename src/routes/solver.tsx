...
export const Route = createFileRoute("/solver")({
  ...
  head: () => ({
    meta: [
      { title: trs("কণিকের সাধারণ সমীকরণ সমাধান — Conic Studio") },
      {
        name: "description",
        content: trs(
      ...
      { property: "og:title", content: trs("কণিকের সাধারণ সমীকরণ সমাধান") },
      { property: "og:description", content: trs("Capital Variable পদ্ধতিতে ধাপে ধাপে ব্যাখ্যা।") },
    ...
    <PageShell>
      <main className="page-main">
        <section className="neon-hero fade-in">
          ...
          <h1>
            {trs("যেকোন কণিক সমীকরণের")}{" "}
            <span className="neon-gradient-text">{trs("ধাপে ধাপে")}</span> {trs("সম্পূর্ণ সমাধান")}
          </h1>
          <p>
            {trs(
        ...
        <section className="neon-card fade-in" style={{ marginTop: 16 }}>
          <div className="card-title">
            <h2>
              <Wand2
                size={16}
                style={{ verticalAlign: "-3px", marginRight: 8, color: "#00F0FF" }}
              />
              {trs("সমীকরণ ইনপুট")}
            </h2>
          ...
          <label className="fld">
            <span>{trs("সমীকরণ লিখুন (উদা: y^2 = 4x + 4y − 8)")}</span>
            <input
          ...
          <div className="rule-box">
            <h4>{trs("সবচেয়ে সহজ নিয়ম (ধাপে ধাপে মনে রাখো)")}</h4>
            <ul>
              <li>
                {trs("ধাপ ১: সব পদ এক পাশে এনে সাধারণ রূপ Ax² + Cy² + Dx + Ey + F = 0 বানাও।")}
              </li>
              <li>
                {trs(
              ...
              <li>
                {trs("ধাপ ৩: x ও y আলাদা করে বর্গ সম্পূর্ণ করো — সহগের অর্ধেকের বর্গ যোগ করো।")}
              </li>
              <li>{trs("ধাপ ৪: X = x − α, Y = y − β বসাও; সমীকরণ প্রামাণ্য রূপে চলে আসবে।")}</li>
              <li>
                {trs(
              ...
              <li>
                {trs("ধাপ ৬: শেষে X = x − α, Y = y − β ফিরিয়ে দিয়ে ছোট x, y-তে উত্তর লেখো।")}
              </li>
            </ul>
          </div>
        </section>
        ...
        {result.ok ? (
          <>
            <section className="neon-card fade-in" style={{ marginTop: 16 }}>
              <div className="neon-status ok">
                <div className="neon-status-row">
                  <span className="neon-badge cyan">{trs("সনাক্তকৃত ধরন")}</span>
                  <strong>{kindLabel}</strong>
                </div>
                <div className="neon-status-row">
                  <span className="neon-badge magenta">{trs("প্রামাণ্য রূপ")}</span>
                  <code>{toBn(result.solution.standard)}</code>
                </div>
                <div className="neon-status-row">
                  <span className="neon-badge purple">{trs("মূলধন চলকে")}</span>
            ...
            <section
              className="neon-card graph-card fade-in"
              style={{ marginTop: 16 }}
              ref={graphRef}
              id="graph"
            >
              <div className="graph-head">
                ...
                <div className="graph-tools">
                  <span className="chip">
                    <span className="dot" style={{ background: ADV_COLORS.curve }} />
                    {trs("বক্ররেখা")}
                  </span>
                  <span className="chip">
                    <span className="dot" style={{ background: ADV_COLORS.vertex }} />
                    {trs("শীর্ষ/কেন্দ্র")}
                  </span>
                  <span className="chip">
                    <span className="dot" style={{ background: ADV_COLORS.focus }} />
                    {trs("ফোকাস")}
                  </span>
                  <span className="chip">
                    <span className="dot" style={{ background: ADV_COLORS.directrix }} />
                    {trs("নিয়ামক")}
                  </span>
                  <span className="chip">
                    <span className="dot" style={{ background: ADV_COLORS.latus }} />
                    {trs("উপকেন্দ্রিক লম্ব")}
                  </span>
                </div>
              </div>
            ...
            <section className="neon-card fade-in" style={{ marginTop: 16 }}>
              <div className="card-title">
                <h2>
                  <Zap
                    size={16}
                    style={{ verticalAlign: "-3px", marginRight: 8, color: "#B026FF" }}
                  />{" "}
                  {trs("ধাপে ধাপে সমাধান")}
                </h2>
              </div>
            ...
            <section className="neon-card fade-in" style={{ marginTop: 16 }}>
              <div className="card-title">
                <h2>{trs("সম্পূর্ণ উপাদান তালিকা")}</h2>
              </div>
          ...
          <section className="neon-card fade-in" style={{ marginTop: 16 }}>
            <div className="neon-status err">
              <div className="neon-status-row">
                <span className="neon-badge err">{trs("ত্রুটি")}</span>
                <strong>{result.error}</strong>
              </div>
              {result.suggestion && (
                <div className="neon-status-row">
                  <span className="neon-badge">{trs("পরামর্শ")}</span>
