...
export const Route = createFileRoute("/ellipse-formulas")({
  head: () => ({
    meta: [
      { title: "উপবৃত্তের সূত্রাবলী — Conic Studio" },
      { name: "description", content: "উপবৃত্তের সকল উপাদান — কেন্দ্র, উৎকেন্দ্রিকতা, অক্ষ, ফোকাস, নিয়ামক, উপকেন্দ্রিক লম্ব — সরিত ও অসরিত কেসের সম্পূর্ণ সূত্র টেবিল।" },
      { property: "og:title", content: "উপবৃত্তের সূত্রাবলী চার্ট" },
      { property: "og:description", content: "১৪টি উপাদানের নিয়ন সূত্র টেবিল উপবৃত্তের সকল কেসের জন্য।" },
...
const rowsMain: FormulaRow[] = [
  ...
  { label: "ফোকাসদ্বয় (উপকেন্দ্র)", cells: ["(±ae, 0) বা (±√(a²−b²), 0)", "(0, ±be) বা (0, ±√(b²−a²))"] },
    ...
    <PageShell>
      <main className="page-main">
        <section className="neon-hero fade-in">
          <span className="neon-hero-badge">উপবৃত্ত · Ellipse</span>
          <h1>উপবৃত্তের <span className="neon-gradient-text">সম্পূর্ণ সূত্রাবলী</span></h1>
          <p>মূল ও সরিত উপবৃত্তের ১৪টি উপাদানের নিয়ন টেবিল — উভয় ওরিয়েন্টেশন (a&gt;b এবং b&gt;a) সহ।</p>
        </section>

        <section className="neon-card fade-in">
          <h2>মূল উপবৃত্ত (কেন্দ্র মূলবিন্দুতে)</h2>
          <FormulaTable
            accent="cyan"
            headers={[<>x²/a² + y²/b² = 1<br/><small>a &gt; b, বৃহৎ অক্ষ x বরাবর</small></>, <>x²/a² + y²/b² = 1<br/><small>b &gt; a, বৃহৎ অক্ষ y বরাবর</small></>]}
            rows={rowsMain}
          />
        </section>

        <section className="neon-card fade-in">
          <h2>সরিত উপবৃত্ত (কেন্দ্র (α, β))</h2>
          <FormulaTable
            accent="purple"
            headers={[<>(x−α)²/a² + (y−β)²/b² = 1<br/><small>a &gt; b</small></>, <>(x−α)²/a² + (y−β)²/b² = 1<br/><small>b &gt; a</small></>]}
            rows={rowsShifted}
          />
        </section>
      </main>
