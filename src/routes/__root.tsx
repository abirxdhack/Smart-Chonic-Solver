...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: trs("Conic Studio — পরাবৃত্ত, উপবৃত্ত ও অধিবৃত্ত সমাধান") },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/66d4606f-85d7-47dc-8f81-54cc5a9c8688",
      },
      {
        name: "twitter:image",
        content:
